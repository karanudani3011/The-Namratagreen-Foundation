        ...
        <footer style={footerStyle}>
                ...
                <div>
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1.5rem' }}>
                            ...
                            <a
                                href="https://wa.me/8200012906?text=Hello%20Namrata%20Green%20Foundation"
                                target="_blank"
            ...
            <div className="container" style={{ textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '2rem' }}>
                <p style={{ opacity: 0.6, fontSize: '0.9rem' }}>
                    &copy; {new Date().getFullYear()}  Namratagreen Foundation Inc. All rights reserved.
                </p>
            </div>
        </footer >
    );
